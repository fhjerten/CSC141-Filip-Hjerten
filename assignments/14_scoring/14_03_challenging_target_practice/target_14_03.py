...
class Target(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        # This is changed: each target has its own speed
        self.speed = float(self.settings.target_speed)

    def update(self):
# changed here: each target moves according to its own speed
...
# changed: new method to reset speed
